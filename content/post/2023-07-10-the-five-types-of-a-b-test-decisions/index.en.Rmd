...
lean_startup, nrow=2)
```
_Perhaps-useful intuitions for the five types of decisions._
...
* *Planning*: Run the test until you’re _quite likely to detect the _smallest positive impact_ on the key metric that would cause a roll-out decision.
